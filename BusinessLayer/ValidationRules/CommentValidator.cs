...
namespace BusinessLayer.ValidationRules
{
    public class CommentValidator : AbstractValidator<Comment>
    {
        ...
        {
            RuleFor(x => x.CommentUserName).NotEmpty().WithMessage("Ad Soyad adı boş olamaz").MinimumLength(5).WithMessage("Ad Soyad adı en az 5 karekter olabilir.").MaximumLength(30).WithMessage("Ad Soyad en az fazla 50 karekter olabilir.");
